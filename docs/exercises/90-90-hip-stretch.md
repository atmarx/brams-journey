...
- **[Internal rotation](https://en.wikipedia.org/wiki/Rotation_(anatomy))** is lost first with sitting and age
- **[External rotation](https://en.wikipedia.org/wiki/Rotation_(anatomy))** also becomes restricted
- The [hip capsule](https://en.wikipedia.org/wiki/Capsule_of_hip_joint) thickens in unused positions
...
1. Sit on floor (or on yoga block/folded blanket if hips very tight)
2. Bend right leg in front, knee pointing forward
3. Right shin roughly parallel to front edge of mat (perpendicular to your body)
4. Right knee bent at 90°, right ankle flexed (toes pulled back)
5. Bend left leg behind, knee pointing to the left
6. Left shin roughly parallel to front edge of mat
7. Left knee bent at 90°, left ankle flexed
8. You've created a "Z" or "90/90" shape
9. Sit upright with spine vertical, hands on floor for support

!!! warning "Starting Position Alone Is a Stretch"
...
1. Keep spine tall
2. Hinge forward at hips (not waist—don't round back)
3. Walk hands forward in front of right shin
4. Feel stretch in outside of right hip and buttock
5. Hold 90 seconds, breathing deeply

### Progression 2: Back Leg (Internal Rotation)

1. Sit back upright
2. Lean torso gently toward left (toward back leg)
3. Place left forearm on floor if possible
4. Feel stretch in front and inside of left hip
5. Hold 90 seconds
...
- Deep stretch in outer hip/[glute](https://en.wikipedia.org/wiki/Gluteal_muscles) (front leg)
- Stretch in [hip flexor](https://en.wikipedia.org/wiki/Hip_flexors)/inner thigh (back leg)
...
??? question "Can't get into position at all"
...
??? question "Knee pain in front or back leg"
...
??? question "Back rounds forward when trying to sit upright"
...
??? question "Feel it in knee, not hip"
...
??? question "One side dramatically tighter than other"
...
- **Getting up from floor:** "Used to be this whole production—hands on knee, struggle up, pain. Now I just stand up. Like a normal person. Revolutionary."

- **Truck entry/exit:** "Used to have to swing one leg out, then the other, slow and stiff. Now I just step out normally. Hips rotate freely."

- **Squatting:** "Picking things up from ground level used to require creative strategies. Now I just squat down, grab it, stand up. Normal human movement restored."

- **Knee pain:** "I thought I had bad knees. Turns out I had bad hips that were torquing my knees. Fix the hips, knees stopped hurting."
...
**Next:** [Hip Flexor Stretch →](hip-flexor-stretch.md)
