...
- Pulls shoulders forward and down ([protraction](https://en.wikipedia.org/wiki/Protraction_(kinesiology)))
- Prevents proper [scapular retraction](https://en.wikipedia.org/wiki/Retraction_(kinesiology)) (shoulder blades back)
- Contributes to rounded shoulders, [shoulder impingement](https://en.wikipedia.org/wiki/Shoulder_impingement_syndrome), neck pain
- Restricts overhead motion
...
### Position 3: High Angle (Upper Pec and [Anterior Deltoid](https://en.wikipedia.org/wiki/Deltoid_muscle))
...
!!! danger "Critical: Scapular Position"
...
??? question "Shoulder pain (sharp or pinching) during stretch"
...
??? question "Don't feel anything in chest"
...
??? question "Neck tension when stretching"
...
??? question "Feel it in bicep instead of chest"
...
**Recommended:** 
- Morning: 1 position (mid-height), 60 seconds each side
- Evening: All 3 positions, 60 seconds each = 6 minutes total

---

**Next:** [Supine Spinal Twist →](supine-spinal-twist.md)
