...
- Contribute to [shoulder impingement](https://en.wikipedia.org/wiki/Shoulder_impingement_syndrome)
- Create compensatory tension throughout the spine

Child's pose creates [spinal traction](https://en.wikipedia.org/wiki/Spinal_decompression)—gravity gently pulls vertebrae apart—while the side-angling isolates the lat stretch on each side.
...
1. Kneel on mat, knees wide apart (wider than hip-width)
2. Big toes touch behind you
3. Sit hips back toward heels as far as comfortable
4. *If too intense:* Place folded towel or pillow between buttocks and heels
5. Extend both arms forward on mat, palms down
6. Forehead rests on mat (or on folded towel/block if can't reach)
...
1. Walk both hands to the right side, angling arms about 45° from center
2. Keep hips centered—don't let left hip lift off heels
3. Feel stretch along entire left side of body, particularly under left shoulder blade and down left lat
4. Left arm is reaching diagonally across body
5. Hold 2 minutes, breathing deeply

**Left side (2 minutes):**

1. Walk hands through center to left side
2. Right arm now reaching diagonally
3. Feel stretch along right side
4. Hold 2 minutes
...
1. **Inhale:** Breathe deeply into the side that's being stretched
2. **Exhale:** Sink slightly deeper, let the body get heavier
3. **Feel the expansion:** Ribcage should move outward against the lat stretch
4. **Each exhale:** Incrementally deeper relaxation
...
- Deep stretch along the side body (lat, [obliques](https://en.wikipedia.org/wiki/Abdominal_external_oblique_muscle))
...
1. Take right arm and thread it under left arm
2. Right shoulder comes toward floor
3. Adds thoracic rotation to the lat stretch
...
??? question "Can't sit hips back to heels"
...
??? question "Forehead doesn't reach floor"
...
??? question "Don't feel lat stretch when walking hands to side"
...
??? question "Shoulders bunched up by ears, neck tension"
...
??? question "Lower back pain in this position"
...
- **Overhead work:** After three months of consistent lat stretching, Bram could reach overhead without his lower back arching. His shoulders did the work instead of compensating with his spine.

- **End-of-day relief:** "I used to come home feeling like I'd been compressed in a vice all day. Five minutes in child's pose with lat stretch and I could feel the space coming back between my vertebrae."

- **Sleep quality:** Doing this before bed helped decompress the day's accumulated tension, leading to better sleep and less morning stiffness.
...
**Next:** [90/90 Hip Stretch →](90-90-hip-stretch.md)
