...
**[Part I: The Unraveling](journey/chapter-1-when-did-it-start.md)** — How a strong, capable contractor slowly lost the ability to do his job, and why he almost didn't notice until it was nearly too late.

**[Part II: The Investigation](journey/chapter-3-crisis-point.md)** — The ladder incident that forced action, finding a doctor who listened, and discovering the hidden mold that was poisoning him.

**[Part III: The Recovery Protocols](protocols/index.md)** — Diet, supplements, cannabis, mushrooms, and movement—the multi-pronged approach that turned things around.

**[Part IV: The Transformation](journey/chapter-7-nine-months-taking-stock.md)** — Nine months to one year later: objective measures, unexpected benefits, and building a life around sustainable health.

[**Begin Bram's Journey →**](journey/chapter-1-when-did-it-start.md){ .md-button .md-button--primary }
...
-   :material-yoga:{ .lg .middle } **Daily 8 Foundation**

    ---

    Morning and evening stretches that address the root causes of chronic pain. 15-20 minutes, done at home.

    [:octicons-arrow-right-24: View exercises](exercises/daily-8.md)

-   :material-hammer-wrench:{ .lg .middle } **Invisible 8 Job Site**

    ---

    Exercises that look like normal behavior. Do them while working, waiting, or talking—no one will know.

    [:octicons-arrow-right-24: View exercises](exercises/invisible-8.md)

-   :material-desktop-classic:{ .lg .middle } **Office Worker Adaptations**

    ---

    The Invisible 8 modified for desk work. Combat sitting disease[^sitting] without leaving your workspace.

    [:octicons-arrow-right-24: View exercises](exercises/office-worker.md)

</div>

[^sitting]: "Sitting disease" refers to the metabolic and musculoskeletal consequences of prolonged sedentary behavior. Research links excessive sitting to increased risk of cardiovascular disease, diabetes, and musculoskeletal disorders. See: [Mayo Clinic - Sitting risks](https://www.mayoclinic.org/healthy-lifestyle/adult-health/expert-answers/sitting/faq-20058005)

### Recovery Protocols

<div class="grid cards" markdown>

-   :material-food-apple:{ .lg .middle } **Anti-Inflammatory Diet**

    ---

    What to eat, what to avoid, and why it matters. Practical meal prep for busy people.

    [:octicons-arrow-right-24: Read more](protocols/anti-inflammatory-diet.md)

-   :material-pill:{ .lg .middle } **Supplements**

    ---

    Evidence-based supplementation: what works, what's hype, and how to prioritize on a budget.

    [:octicons-arrow-right-24: Read more](protocols/supplements.md)

-   :material-cannabis:{ .lg .middle } **Cannabis as Medicine**

    ---

    From skeptic to advocate: responsible medical use for inflammation and pain.

    [:octicons-arrow-right-24: Read more](protocols/cannabis.md)

-   :material-mushroom:{ .lg .middle } **Medicinal Mushrooms**

    ---

    Reishi, lion's mane, cordyceps, and more. The science and practical application.

    [:octicons-arrow-right-24: Read more](protocols/mushrooms.md)

</div>

### Practical Resources

- [**30-Day Starter Protocol**](resources/30-day-starter.md) — Overwhelmed? Start here.
- [**Tracking Templates**](resources/tracking-templates.md) — Printable journals for symptoms and progress
- [**Meal Planning Guide**](resources/meal-planning.md) — Weekly prep strategies
- [**Supplement Schedule**](resources/supplement-schedule.md) — What to take and when
- [**Mold Remediation Checklist**](resources/mold-remediation.md) — Finding and fixing environmental issues
- [**Further Reading**](resources/further-reading.md) — Books, websites, and finding practitioners
...
[**Start Bram's Journey →**](journey/chapter-1-when-did-it-start.md){ .md-button .md-button--primary }
[**Jump to Exercises →**](exercises/index.md){ .md-button }
