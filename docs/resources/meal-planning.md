...
1. **Wild-caught fish** — Avoid farmed salmon (inflammatory [omega-6](https://en.wikipedia.org/wiki/Omega-6_fatty_acid) ratio)
2. **Pastured eggs** — Better [fatty acid profile](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2904416/)
3. **Grass-fed beef** — When possible, or at least for ground beef
4. **Organic leafy greens** — Highest pesticide load in conventional (see [EWG Dirty Dozen](https://www.ewg.org/foodnews/dirty-dozen.php))
5. **Quality olive oil** — Real [EVOO](https://en.wikipedia.org/wiki/Olive_oil#Extra_virgin), not blended/adulterated
...
??? question "I don't have time to cook every night"
...
??? question "My family won't eat this way"
...
??? question "I travel for work frequently"
...
??? question "I get bored eating the same things"
...
*Continue to [Supplement Schedule](supplement-schedule.md) or return to [Resources](index.md)*
