...
3. "Can you provide references from recent jobs?"
4. "Will you provide a detailed written work plan?"
5. "What containment methods do you use?"
6. "Do you use HEPA filtration?"
7. "Is post-remediation testing included?"
8. "Do you address the moisture source, or just remove mold?"
...
| Test | Pass Criteria |
|------|--------------|
| **[ERMI](https://en.wikipedia.org/wiki/Environmental_Relative_Moldiness_Index) Score**[^ermi] | < 2 (significantly lower than pre-remediation) |
...
[^ermi]: The Environmental Relative Moldiness Index (ERMI) was developed by the [EPA](https://www.epa.gov/mold/microbiological-and-chemical-exposure-assessment-mold-analysis-methods) using DNA-based testing to quantify 36 mold species. Scores above 5 indicate elevated mold; above 10 indicates severe contamination.

**If Testing Fails:**

1. Do not accept work as complete
2. Require remediator to address remaining issues
3. Retest after additional work
4. Do not make final payment until clearance achieved
...
4. HEPA vacuum entire area after cleaning
5. Bag all contaminated materials in plastic
...
**Scope of Work:**
- Complete bathroom tear-out
- Master bedroom wall section removal
- Crawlspace encapsulation + dehumidifier
- HVAC duct cleaning
- Total: $24,500

**Timeline:**
- 3 weeks for remediation
- 2 weeks additional for repairs
- Relocated to rental during process
...
- **IICRC Locator:** [iicrc.org/locator](https://iicrc.org/locator)
- **NORMI Certified Professionals:** [normi.org](https://normi.org)
- **ACAC Directory:** [acac.org](https://acac.org)

### Testing Labs

- **ERMI Testing:** [Mycometrics](https://mycometrics.com) — EPA-licensed ERMI analysis
- **EMLab P&K:** [emlab.com](https://emlab.com) — Various mold testing services

### Additional Information

- **EPA Mold Resources:** [epa.gov/mold](https://epa.gov/mold) — Official guidance documents
- **Surviving Mold:** [survivingmold.com](https://survivingmold.com) — Dr. Ritchie Shoemaker's CIRS resources
- **ISEAI:** [iseai.org](https://iseai.org) — International Society for Environmentally Acquired Illness

---

*Continue to [Further Reading](further-reading.md) or return to [Resources](index.md)*
