...
-   :material-clock-alert:{ .lg .middle } **Chapter 1: When Did It Start?**

    ---

    The early warning signs Bram dismissed. The normalization of pain. The adaptations that hid how bad things were getting.

    [:octicons-arrow-right-24: Read Chapter 1](chapter-1-when-did-it-start.md)

-   :material-lightning-bolt:{ .lg .middle } **Chapter 2: The Cascade**

    ---

    The ladder incident. The urgent care dismissal. The research rabbit hole that revealed the truth hiding in his own house.

    [:octicons-arrow-right-24: Read Chapter 2](chapter-2-the-cascade.md)
...
-   :material-hospital:{ .lg .middle } **Chapter 3: Crisis Point**

    ---

    Dr. Sarah Chen. The comprehensive testing. Finally being heard after months of dismissal.

    [:octicons-arrow-right-24: Read Chapter 3](chapter-3-crisis-point.md)

-   :material-test-tube:{ .lg .middle } **Chapter 4: The Testing**

    ---

    Blood work, inflammatory markers, and the data that proved Bram wasn't crazy. CRP at 15.2 when normal is under 3.

    [:octicons-arrow-right-24: Read Chapter 4](chapter-4-the-testing.md)

-   :material-home-search:{ .lg .middle } **Chapter 5: The Home Inspection**

    ---

    ERMI score of 12.7. Stachybotrys behind the walls. The house Bram built with his own hands was poisoning him.

    [:octicons-arrow-right-24: Read Chapter 5](chapter-5-the-home-inspection.md)

-   :material-lightbulb:{ .lg .middle } **Chapter 6: The Revelation**

    ---

    Connecting the dots. The unfinished bathroom. The timeline. The decision to leave everything behind.

    [:octicons-arrow-right-24: Read Chapter 6](chapter-6-the-revelation-and-decision.md)
...
!!! info "Protocol Deep Dives"
    The recovery protocols are covered in detail in their own sections:
    
    - [Anti-Inflammatory Diet](../protocols/anti-inflammatory-diet.md)
    - [Supplement Protocol](../protocols/supplements.md)
    - [Cannabis as Medicine](../protocols/cannabis.md)
    - [The Mycology Awakening](../protocols/mushrooms.md)
    - [Movement Protocols](../exercises/index.md)
...
-   :material-calendar-check:{ .lg .middle } **Chapter 7: Nine Months**

    ---

    CRP from 15.2 to 1.8. Twenty pounds lost. Working full days without pain. The objective measures of transformation.

    [:octicons-arrow-right-24: Read Chapter 7](chapter-7-nine-months-taking-stock.md)

-   :material-trophy:{ .lg .middle } **Chapter 8: One Year**

    ---

    Back on the same ladder. The daily practices that became automatic. The unexpected doors that opened.

    [:octicons-arrow-right-24: Read Chapter 8](chapter-8-one-year-the-new-normal.md)

-   :material-hand-heart:{ .lg .middle } **Chapter 9: Lessons and Legacy**

    ---

    What Bram would tell his past self. What he tells others. The mission that emerged from the crisis.

    [:octicons-arrow-right-24: Read Chapter 9](chapter-9-lessons-and-legacy.md)
...
-   :material-star:{ .lg .middle } **Three Years Later**

    ---

    Keynoting a trades conference. The phone call from David. Full circle.

    [:octicons-arrow-right-24: Read Epilogue](epilogue-three-years-later.md)
...
Ready to begin? Start with [Chapter 1: When Did It Start?](chapter-1-when-did-it-start.md)

Or jump to what's most relevant:

- Struggling with symptoms? → [Chapter 4: The Testing](chapter-4-the-testing.md)
- Suspect your environment? → [Chapter 5: The Home Inspection](chapter-5-the-home-inspection.md)
- Ready to start protocols? → [Recovery Protocols](../protocols/index.md)
- Want practical exercises? → [Exercise Protocols](../exercises/index.md)
